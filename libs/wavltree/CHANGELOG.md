...
## [0.0.9](https://github.com/Mihdi/k23/compare/wavltree-v0.0.8...wavltree-v0.0.9) - 2026-04-10

### Other

- range tree ([#641](https://github.com/Mihdi/k23/pull/641))
- *(deps)* update rust crate libfuzzer-sys to v0.4.12 ([#660](https://github.com/Mihdi/k23/pull/660))
- *(deps)* update rust crate criterion to 0.8.0
- *(kmem)* AddressSpace API and AddressSpaceRegion tree
- *(wavltree)* add context parameter to `assert_valid` method. ([#554](https://github.com/Mihdi/k23/pull/554))
- *(deps)* update rust crate criterion to 0.7.0 ([#508](https://github.com/Mihdi/k23/pull/508))
- rustfmt  items ([#506](https://github.com/Mihdi/k23/pull/506))
